...
namespace WinHttpRedirectProxy::MemoryRuntime
{
        ...
        WinHttpRedirectMemoryIpc::MemoryReplyPayload& reply)
    {
        ...
        while (remaining != 0)
        {
            ...
            // Allow PAGE_GUARD and non-readable pages — the SEH handler in
            // ExecuteProtectedRead/Write will catch any access violations.
            // This matches the in-process dumper behavior which uses memcpy+SEH.
